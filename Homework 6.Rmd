...
p2_tidy %>%
  modelr::add_residuals(p2_tidy, mod_1) %>%
  modelr::add_predictions(p2_tidy, mod_1) %>% 
  ggplot(p2_tidy, aes(x = fincome, y = bwt)) + geom_point() + geom_line(aes(y = pred), color = "red") + geom_line(aes(y = resid), color = "blue")
...
modelr::add_residuals(p2_tidy, mod_2)
  add_predictions(mod_2) 
  ggplot(aes(x = , y = bwt)) + geom_point() + geom_line(aes(y = pred), color = "red") + geom_line(aes(y = resid), color = "blue")
